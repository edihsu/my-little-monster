...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        2. selector is function that you will call, "itemDroppedOnCharacter:" 
            : means one or more parameters. If colum is not there, it will look for function with no parameters.
            and NSNotifications pass in a Notification object pareameter, must have colum or function will not be called.
