...
SWIFT_CLASS("_TtC15mylittlemonster11AppDelegate")
...
SWIFT_CLASS("_TtC15mylittlemonster7DragImg")
@interface DragImg : UIImageView
@property (nonatomic, strong) UIView * __nullable dropTarget;
...
SWIFT_CLASS("_TtC15mylittlemonster10MonsterImg")
@interface MonsterImg : UIImageView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, weak) IBOutlet MonsterImg * __null_unspecified monsterImg;
@property (nonatomic, weak) IBOutlet DragImg * __null_unspecified foodImg;
@property (nonatomic, weak) IBOutlet DragImg * __null_unspecified heartImg;
